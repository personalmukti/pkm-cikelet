                                ...
                                <div class="single-blog-item blog-item">
                                    ...
                                    <div class="blog-text" style="margin: 25px !important;">
                                        ...
                                        <div class="text-justify">
                                            <p><?php echo limit_words($isi, 30); ?>
                                                <br><a href="<?php echo base_url() . 'NewsHub/detailnews/' . $id; ?>" class="btn btn-info btn-xs"> Selengkapnya </a>
                                            </p>
                                        </div>
                                        <hr>
                                        <div class="text-center">
                                            <h6>Posted by : <?php echo $poster; ?></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
