            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mini-title inner-style-2">
                        ...
                        <p><a href="<?php echo base_url() ?>">Home</a> <span class="fa fa-angle-right"></span> <a href="<?php echo base_url() ?>penghargaan-prestasi">Penghargaan dan Prestasi</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row clearfix">
                    <div class="gallery-filter-item text-center">
                        <ul class="gallery-filter">
                            <li class="active"><a href="#" data-filter="*" class="current">Semua</a></li>
                            <li class=""><a href="#" data-filter=".gp-two" class="current">Penghargaan</a></li>
                            <li class=""><a href="#" data-filter=".gp-three" class="current">Sertifikat</a></li>
                            <li class=""><a href="#" data-filter=".gp-four" class="current">Izin</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="gallery col-3 gutter">
                        <div class="gallery-item gp-two">
                            <div class="penghargaanimg">
                                <img class="penghargaanimg" src="<?php echo base_url() ?>assets/medicative/img/achievement/penghargaanbupati.jpg" alt="">
                        ...
                        <div class="gallery-item gp-three">
                            <div class="penghargaanimg">
                                <img class="penghargaanimg" src="<?php echo base_url() ?>assets/medicative/img/achievement/sertifikatlembaga.png" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                        ...
                        <div class="gallery-item gp-three">
                            <div class="penghargaanimg">
                                <img class="penghargaanimg" src="<?php echo base_url() ?>assets/medicative/img/achievement/sertifikatbpjs.jpg" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                        ...
                        <div class="gallery-item gp-three">
                            <div class="penghargaanimg">
                                <img class="penghargaanimg" src="<?php echo base_url() ?>assets/medicative/img/achievement/sertifikatapresiasi.jpg" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
